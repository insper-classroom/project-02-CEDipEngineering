...
'''
Code found in https://debuggercafe.com/implementing-resnet18-in-pytorch-from-scratch

Implementation by Sovit Ranjan Rath, September 19, 2022
...
class ResNet(torch.nn.Module):
    ...
    def __init__(
        ...
        self.fc = torch.nn.Linear(128*self.expansion, num_classes)
